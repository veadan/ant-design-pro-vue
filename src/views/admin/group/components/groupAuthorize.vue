<template>
  <a-row>
    <a-col :span="24">
      <a-button type="primary" v-if="groupManager_authorize_menu" @click="update">保存</a-button>
    </a-col>
    <a-col :span="6" style="margin-top:15px;margin-right:10px">
      <a-input placeholder="输入关键字进行过滤" style="margin-bottom: 10px" v-model="filterText"> </a-input>
      <el-tree
        class="filter-tree"
    ...
    <a-col :span="17" style="margin-top:15px;">
      <el-table
        ref="elementTable"
        :data="list"
        border
        ...
        <el-table-column width="250px" align="center" label="资源地址">
          <template slot-scope="scope">
            <span>
              {{ scope.row.uri }}</span>
          </template>
        </el-table-column>
        <el-table-column width="124px" align="center" label="请求类型">
          <template slot-scope="scope">
            <span>
